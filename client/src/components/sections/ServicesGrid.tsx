    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <Link href="/services">
             <a className="text-white hover:text-[var(--aquamarine)] transition-colors flex items-center gap-2 text-sm font-medium group uppercase tracking-widest">
        ...
        >
          {services.map((service, index) => (
            <motion.div key={index} variants={transitions.stagger.item as any}>
                <GlassCard hoverEffect spotlight className="flex flex-col h-full min-h-[320px] group bg-white/[0.02]">
                <div className="w-14 h-14 rounded-2xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center mb-8 text-white group-hover:scale-110 group-hover:bg-[var(--rare-blue)] group-hover:border-[var(--rare-blue)] transition-all duration-500 shadow-lg">
                ...
                <div className="flex items-center text-xs font-medium uppercase tracking-wider text-white/40 group-hover:text-white transition-colors">
          ...
          <motion.div variants={transitions.stagger.item as any}>
            <GlassCard hoverEffect spotlight className="relative overflow-hidden border-[var(--rare-blue)]/30 bg-gradient-to-br from-[var(--rare-blue)]/10 to-[var(--deep-midnight)]/50 group p-0 h-full">
                ...
                <div className="absolute -right-20 -bottom-20 w-80 h-80 opacity-40 transition-transform duration-700 group-hover:scale-110 group-hover:rotate-12 mix-blend-lighten">
                ...
                <Link href="/ai-integration">
                    <MotionButton className="w-full bg-white text-black hover:bg-white/90 border-0 font-bold h-12 text-sm shadow-lg shadow-white/10">
