      ...
      <main className="pt-32 pb-24 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mb-24 mx-auto text-center">
            <span className="text-primary font-mono text-sm tracking-[0.2em] uppercase mb-6 block">Capabilities</span>
          ...
          <div className="grid gap-8 max-w-5xl mx-auto">
            {serviceDetails.map((service, index) => (
              <GlassCard key={index} className="p-8 md:p-12 border-white/5 bg-white/[0.02]" spotlight>
                <div className="grid md:grid-cols-2 gap-12 items-start">
                  <div>
                    ...
                    <div className="mb-8 p-4 rounded-xl bg-white/5 border border-white/5 inline-block">
                      <h4 className="text-xs font-bold uppercase tracking-widest text-primary mb-2">Best For</h4>
                  ...
                  <div className="bg-black/20 rounded-2xl p-8 border border-white/5 backdrop-blur-sm shadow-inner">
                    <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-white flex items-center gap-2">
                        <Sparkles size={14} className="text-primary" /> Deliverables
                    </h4>
                    <ul className="space-y-4">
                      {service.deliverables.map(item => (
                        <li key={item} className="flex items-center gap-4 text-muted-foreground hover:text-white transition-colors group">
                          <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-primary shrink-0 group-hover:bg-primary group-hover:text-white transition-colors border border-white/5">
                            <Check size={14} />
                          </div>
