  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <main className="pt-32 pb-24 relative">
        <div className="absolute top-0 left-0 w-full h-[80vh] bg-gradient-to-b from-primary/10 via-background to-background pointer-events-none" />
        <BackgroundBeams />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 text-primary text-xs font-mono mb-6 border border-primary/20">
                BILKUL INTELLIGENCE LAYER
              </div>
              <h1 className="text-6xl md:text-8xl font-display font-bold mb-8 leading-[0.9]">
                Your Business, <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-violet-400 to-white">Supercharged.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <MotionButton variant="outline" size="lg" className="rounded-full h-12 px-8">View Use Cases</MotionButton>
              </div>
            </div>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-secondary/20 blur-[100px] rounded-full" />
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-32">
            {[
              ...
              <GlassCard key={i} spotlight className="p-10 min-h-[300px] flex flex-col justify-between group">
                <div>
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
               <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">AI Readiness Checklist</h2>
               <p className="text-muted-foreground text-lg">Before we build, we qualify.</p>
            </div>
            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-6 p-8 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors group">
                  <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center shrink-0 text-muted-foreground group-hover:border-primary group-hover:text-primary transition-colors">
          ...
          {/* Trust/Safety */}
          <GlassCard className="p-12 md:p-20 border-primary/20 bg-gradient-to-br from-primary/10 to-transparent relative overflow-hidden">
